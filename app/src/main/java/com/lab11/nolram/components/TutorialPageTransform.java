 ...
 */
public class TutorialPageTransform implements ViewPager.PageTransformer {
    ...
    public void transformPage(View page, float position) {
        ...
        View backgroundView = page.findViewById(R.id.intro_background);
        ...
        if (position <= -1.0f || position >= 1.0f) {
            ...
            View computer = page.findViewById(R.id.image_tutorial);
            View image_02_tut = page.findViewById(R.id.image_02_tut);
            View image_03_tut = page.findViewById(R.id.image_03_tut);
            View image_04_tut = page.findViewById(R.id.image_04_tut);
            View image_05_tut = page.findViewById(R.id.image_05_tut);

            if(image_02_tut != null && position < 0){
                image_02_tut.setTranslationY(-pageWidthTimesPosition / 2f);
                image_02_tut.setAlpha(1.0f - absPosition);
            }else if(image_02_tut != null && position >= 0){
                image_02_tut.setTranslationY(pageWidthTimesPosition / 2f);
                image_02_tut.setAlpha(1.0f - absPosition);
            }

            if(image_03_tut != null && position < 0){
                image_03_tut.setTranslationY(-pageWidthTimesPosition / 2f);
                image_03_tut.setAlpha(1.0f - absPosition);
            }else if(image_03_tut != null && position >= 0){
                image_03_tut.setTranslationY(pageWidthTimesPosition / 2f);
                image_03_tut.setAlpha(1.0f - absPosition);
            }

            if(image_04_tut != null && position < 0){

            }else if(image_04_tut != null && position >= 0){

            }

            if(image_05_tut != null && position < 0){

            }else if(image_05_tut != null && position >= 0){
